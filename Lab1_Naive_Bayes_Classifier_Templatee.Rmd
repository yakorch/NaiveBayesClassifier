...
# To test the Bayes Classifier on real-world data, use the method predict_from_string() method. Better use longer messages. Some examples would be:
```{r}
model$predict_from_string("You have won a mobilw phone. To get a free phone, call us at humber 2837123792!!!")
