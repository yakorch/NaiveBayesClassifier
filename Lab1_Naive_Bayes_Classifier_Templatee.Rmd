...
naiveBayes <- setRefClass("naiveBayes",
       ...
       methods = list(
                    ...
                    calc_probability = function (word, df){
                        pos = which(df["word"] == word)
                        if (length(pos) == 0){
                          # no occurence
                        }
                        else {
                          occurences = spam_df["n"][pos, ]
                        }
                    ...
                    score = function(X_test, y_test)
                      ...
                      Precision <- spam_true_amount / nrow(X_test)
                      
                      ham_false <- y_test[y_test$result == FALSE, ]
                      ham_false_amount <- nrow(ham_false)
                      Recall <- spam_true_amount / (ham_false_amount + spam_true_amount)
                      ...
                      numbers_of_guesses = 
                        c(spam_true_amount, ham_true_amount, spam_false_amount
                          ,ham_false_amount)
                      par(mfrow = c(1, 2))
                      ...
                      barplot(numbers_of_guesses,
                              ...
                              names.arg = c("Predicted right spam", "Predicted right 
                                            ham", 
                                            "Predicted wrong spam", "Predicted wrong 
                                            ham"),
